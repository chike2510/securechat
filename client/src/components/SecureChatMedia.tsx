...
export function EncryptedAttachmentCard({ conversation, attachment, keyVersion }: { conversation: MediaConversation; attachment: Attachment; keyVersion?: string }) {
  ...
  return <div className={`mt-2 w-full min-w-0 max-w-full overflow-hidden rounded-[24px] border p-3 shadow-sm ${voice ? "border-[#d4b3c9]/70 bg-[linear-gradient(135deg,rgba(255,255,255,.94),rgba(244,232,241,.9))] dark:border-[#69536c] dark:bg-[#26333f]" : "border-current/20 bg-black/5"}`}>
