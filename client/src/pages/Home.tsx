...
export default function Home() {
  ...
  return <div className="min-h-[100dvh] w-full max-w-full overflow-x-hidden blueprint-bg text-[#101722]">
    ...
    <main className="mx-auto h-[calc(100dvh-4rem)] w-full max-w-[1600px] min-w-0 p-0 md:p-6"><div className="flex h-full w-full min-w-0 max-w-full overflow-hidden bg-white/75 shadow-[0_24px_80px_rgba(16,23,34,0.10)] md:border md:border-slate-900/15">
